...
const FAQ_ITEMS = [
  {
    ...
    paragraphs: [
      "ㄴ 가능합니다! Spotify 앱의 유료 유저가 아니어도, Orangebeats의 서비스를 이용하실 수 있습니다.",
    ],
  },
  {
    id: "auto-playlist",
    ...
    paragraphs: [
      "ㄴ 곡 후보를 먼저 보여드린 뒤, 사용자가 선택·확정한 곡만 Spotify 플레이리스트에 담습니다.",
    ],
  },
  {
    id: "unmatched",
    ...
    paragraphs: [
      "ㄴ 후보 화면에서 다른 검색 결과를 선택하거나, 해당 곡을 제외한 뒤 다시 생성할 수 있습니다.",
    ],
  },
  {
    id: "opacity",
    ...
    paragraphs: [
      "ㄴ 매칭 신뢰도가 낮은 곡은 행 전체가 더 투명하게 표시됩니다.",
  ...
  return (
    <li className="faq-page__item">
      ...
      {isOpen ? (
        ...
        >
          <div className="faq-page__answer-body">
            {item.paragraphs.map((text) => (
              <p key={text} className="faq-page__answer-text">
                {text}
              </p>
            ))}
          </div>
